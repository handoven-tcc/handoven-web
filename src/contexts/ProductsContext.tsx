...
export function ProductContextProvider({ children }: ProductContextProviderProps) {
  ...
  async function findProductsByFamily(family:string): Promise<void> {
    const res: any = await axios
          .get("https://handovenapi.onrender.com/products?familyId=" + family, {
            headers: {
  ...
  async function deleteProduct(id:string, familyId:string): Promise<void> {
    try {
       const res: any = await axios
       .delete("https://handovenapi.onrender.com/products/" + id, {
         headers: {
    ...
    async function createProduct(req: IProduct) {
      try {
        const res: any = await axios
        .post("https://handovenapi.onrender.com/products",
        {
          name: req.name,
          type: req.type,
    ...
    async function updateProduct(req:IProduct) {
      const res: any = await axios
      .put(`https://handovenapi.onrender.com/products/${req.id}` ,
      {
        name: req.name,
        type: req.type,
        validity: req.validity,

...
export function AuthContextProvider({ children }: AuthContextProviderProps) {
  ...
  async function authenticateUser(reqAuthenticate: reqAuthenticate): Promise<boolean> {
  ...
  async function createUser(user: IUser): Promise<any> {
    ...
    const responseFamily: any = await api
    .post("https://handovenapi.onrender.com/family", {
    ...
    const responseUser: any = await api
    .post("https://handovenapi.onrender.com/user/addUser", {
            name: user.name, 

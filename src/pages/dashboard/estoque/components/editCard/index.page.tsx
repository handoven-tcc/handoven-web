...
export function EditCard(req: createCardProps) {
  ...
  const { updateProduct } = useContextSelector(
    ProductContext,
    (context) => {
      return context;
    }
  ...
  async function handleUpdateProduct() {
    console.log(defaultProduct)
      ...
      await updateProduct({id: defaultProduct.id, name, amount:parseInt(amount), category, cost, expiryProduct,familyId,type,unitMeasure, validity})
      req.handleOpen()
    }
        ...
        <DialogBody divider>
          <div className="flex gap-2 flex-col ">
            ...
            <div className="flex gap-2">
              ...
              <Select 
              label="Categoria" color="gray" className="text-black" defaultValue={Category[category]}
                  >

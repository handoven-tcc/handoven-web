...
export function CreateCard(req: createCardProps) {
  ...
  async function handleCreateProduct() {
    ...
    if(name != "" && category != -1 && type != "" && validity != "" && unitMeasure != "" && cost != "" && amount != "" ) {
      ...
      await createProduct({ name, amount:parseInt(amount), category, cost, expiryProduct,familyId,type,unitMeasure, validity:date  })
    }
  }
        ...
        <DialogBody divider>
          <div className="flex gap-2 flex-col ">
            ...
            <div className="flex gap-2">
              ...
              <Select 
              label="Categoria" color="gray" className="text-black"
                  >
